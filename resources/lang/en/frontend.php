...
return [
    ...
    */
    ...
    'form' => [
        'planet_search' => 'Global planets search',
        'planet_search_description' => 'Find the planet by any possible value',
        'filter' => 'Filter the planets',
        'filter_reset' => 'Reset filters',
        'filter_diameter' => 'Filter list of planets based on diameter.',
        'filter_rotation_period' => 'Filter list of planets based on rotation period.',
        'filter_gravity' => 'Filter list of planets based on gravity.',
        'reset' => 'Reset',
        'diameter' => 'Diameter',
        'rotation_period' => 'Rotation Period',
        'gravity' => 'Gravity',
